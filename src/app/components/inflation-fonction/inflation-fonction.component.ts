...
@Component({
    selector: 'app-inflation-fonction',
    templateUrl: './inflation-fonction.component.html',
    styleUrls: ['./inflation-fonction.component.scss'],
    encapsulation: ViewEncapsulation.None,
})
export class InflationFonctionComponent implements OnInit {
    title : any;
    titlePage : any;
    contentData : any;
    submenuData : any;
    ...
    onSubmitFilter(_dataForm: any) :void {
        if (_dataForm) {
            this.loader = true;
            this._data.postWpData('/bfm/inflation_par_fonction', _dataForm);
            this._data.dataResponse.subscribe(art => {
                if (art.code === codeWS.INFLATION_FONCTION) {
